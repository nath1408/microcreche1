...
<main class="container">
  <div class="row ">
    <div class="col">
      <img src="../images/bienvenue.png" class="float-start" width="200" height="200">
    </div>
    <div class="col">
      <img src="../images/img_4.png" class=" float-left" width="200" height="200">
    </div>
    ...
    <div class="col-md-12">
      ...
      <article class="information">
        <div class="horaire">
          ...
          <p>Saison d'hiver: 7h30 19h30 7 jours sur 7</p>
          <p>Saison d'été: 7h30 19h30 7 jours sur 7</p>
        ...
        <p class="accueil">Quelque soit la commune d'habitation dans le briançonnais, vos enfants sont les bienvenus. Nous les accueillons agés de 3 mois à 4 ans,dans une cadre agréable.
          ...
          Cela permet également d'établir un dialogue constant entre le personnel et les parents.<br>Les parents doivent s'acquitter d'une participation mensuelle. La tarification appliquée aux familles
          par le gestionnaire de la micro crèche est libre, 8.5€ par heure réservée. Les familles peuvent, sous certaines conditionbs, bénéficier de la PAJE versée directement par la CAF ou la MSA. Pour l'obtention de l'aide,
          Les démarches sont à effectuer les familles. La participation des parents est calculée dès la période d'adaptation de l'enfant au sein de la micro crèche.</p><br><br>
        <br><br>
        <h4 class="information-title">Modalités d'accueil et de législation</h4><br>
        <p class="accueil">Nous proposons des contrats d'accueil réguliers ou occasionnels dans la limite des places disponibles, à savoir 10 enfants simultanément. L'inscription se fait par la lecture du réglement
          et le planning mensuel remis à la structure sert de contrat.Le paiement de la prestation s'effectue par mensualisation (lissée sur les saison hiver et été). La micro crèche est ouverte à l'année avec
          2 periodes de fermeture annuelles: 4 semaines de mi-octobre à mi-novembre et 4 semaines de fin avril à fin mai.<br> </p><br><br><br>
        <h5 class="information-title">La Langue Des Signes Bébé (LSB)</h5><br>
